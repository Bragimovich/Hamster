CREATE TABLE IF NOT EXISTS `crime_inmate`.`ut_salt_lake_bonds` (
  ...
  CONSTRAINT `fk_il_tazewell__bonds_il_tazewell__bonds820`
    FOREIGN KEY (`arrest_id`)
    REFERENCES `crime_inmate`.`ut_salt_lake_arrests` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_il_tazewell__bonds_il_tazewell__arrests820`
    FOREIGN KEY (`charge_id`)
    REFERENCES `crime_inmate`.`ut_salt_lake_charges` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
