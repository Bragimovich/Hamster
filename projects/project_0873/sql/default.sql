CREATE TABLE IF NOT EXISTS `crime_inmate`.`nj_doc_inmates` (
...
CREATE TABLE IF NOT EXISTS `crime_inmate`.`nj_doc_inmate_ids` (
  `id` BIGINT(20) NOT NULL AUTO_INCREMENT,
  ...
  INDEX `touched_run_id` (`touched_run_id` ASC),
  INDEX `deleted` (`deleted` ASC),
  INDEX `ind_nj_agegic__nj_doc_inmate_ids_idx` (`inmate_id` ASC),
  CONSTRAINT `ind_nj_agegic__nj_doc_inmate_ids`
    FOREIGN KEY (`inmate_id`)
    REFERENCES `crime_inmate`.`nj_doc_inmates` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION
) ENGINE = InnoDB DEFAULT CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_520_ci;

CREATE TABLE IF NOT EXISTS `crime_inmate`.`nj_doc_inmate_additional_info` (
  `id` BIGINT(20) NOT NULL AUTO_INCREMENT,
  `inmate_id` BIGINT(20) NULL DEFAULT NULL,
  ...
  INDEX `ind_nj_agegic__nj_doc_inmate_additional_info_idx` (`inmate_id` ASC),
  PRIMARY KEY (`id`),
  CONSTRAINT `ind_nj_agegic__nj_doc_inmate_additional_info`
    FOREIGN KEY (`inmate_id`)
    REFERENCES `crime_inmate`.`nj_doc_inmates` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION
...
CREATE TABLE IF NOT EXISTS `crime_inmate`.`nj_doc_inmate_aliases` (
  `id` BIGINT(20) NOT NULL AUTO_INCREMENT,
  `inmate_id` BIGINT(20) NULL DEFAULT NULL,
  `full_name` VARCHAR(255) NULL DEFAULT NULL,
  `first_name` VARCHAR(255) NULL DEFAULT NULL,
  ...
  INDEX `touched_run_id` (`touched_run_id` ASC),
  INDEX `deleted` (`deleted` ASC),
  INDEX `ind_nj_agegic__nj_doc_inmate_aliases_idx` (`inmate_id` ASC),
  CONSTRAINT `ind_nj_agegic__nj_doc_inmate_aliases`
    FOREIGN KEY (`inmate_id`)
    REFERENCES `crime_inmate`.`nj_doc_inmates` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION
...
CREATE TABLE IF NOT EXISTS `crime_inmate`.`nj_doc_mugshots` (
  `id` BIGINT(20) NOT NULL AUTO_INCREMENT,
  `inmate_id` BIGINT(20) NULL DEFAULT NULL,
  ...
  INDEX `touched_run_id` (`touched_run_id` ASC),
  INDEX `deleted` (`deleted` ASC),
  INDEX `ind_nj_agegic__nj_doc_mugshots_idx` (`inmate_id` ASC),
  CONSTRAINT `ind_nj_agegic__nj_doc_mugshots`
    FOREIGN KEY (`inmate_id`)
    REFERENCES `crime_inmate`.`nj_doc_inmates` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION
...
CREATE TABLE IF NOT EXISTS `crime_inmate`.`nj_doc_arrests` (
  `id` BIGINT(20) NOT NULL AUTO_INCREMENT,
  `inmate_id` BIGINT(20) NULL DEFAULT NULL,
  ...
  INDEX `touched_run_id` (`touched_run_id` ASC),
  INDEX `deleted` (`deleted` ASC),
  INDEX `ind_nj_agegic__nj_doc_arrests_idx` (`inmate_id` ASC),
  CONSTRAINT `ind_nj_agegic__nj_doc_arrests`
    FOREIGN KEY (`inmate_id`)
    REFERENCES `crime_inmate`.`nj_doc_inmates` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION
...
CREATE TABLE IF NOT EXISTS `crime_inmate`.`nj_doc_charges` (
  `id` BIGINT(20) NOT NULL AUTO_INCREMENT,
  ...
  INDEX `touched_run_id` (`touched_run_id` ASC),
  INDEX `deleted` (`deleted` ASC),
  INDEX `ind_nj_agegic__nj_doc_charges_idx` (`arrest_id` ASC),
  CONSTRAINT `ind_nj_agegic__nj_doc_charges`
    FOREIGN KEY (`arrest_id`)
    REFERENCES `crime_inmate`.`nj_doc_arrests` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION
) ENGINE = InnoDB DEFAULT CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_520_ci;

CREATE TABLE IF NOT EXISTS `crime_inmate`.`nj_doc_court_addresses` (
...
CREATE TABLE IF NOT EXISTS `crime_inmate`.`nj_doc_court_hearings` (
  `id` BIGINT(20) NOT NULL AUTO_INCREMENT,
  ...
  INDEX `touched_run_id` (`touched_run_id` ASC),
  INDEX `deleted` (`deleted` ASC),
  INDEX `ind_nj_agegic__nj_doc_court_hearings_idx1` (`charge_id` ASC),
  INDEX `ind_nj_agegic__nj_doc_court_hearings_idx2` (`court_address_id` ASC),
  CONSTRAINT `ind_nj_agegic__nj_doc_court_hearings1`
    FOREIGN KEY (`charge_id`)
    REFERENCES `crime_inmate`.`nj_doc_charges` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `ind_nj_agegic__nj_doc_court_hearings2`
    FOREIGN KEY (`court_address_id`)
    REFERENCES `crime_inmate`.`nj_doc_court_addresses` (`court_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION
) ENGINE = InnoDB DEFAULT CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_520_ci;

CREATE TABLE IF NOT EXISTS `crime_inmate`.`nj_doc_holding_facilities` (
  `id` BIGINT(20) NOT NULL AUTO_INCREMENT,
  `arrest_id` BIGINT(20) NULL DEFAULT NULL,
  ...
  INDEX `touched_run_id` (`touched_run_id` ASC),
  INDEX `deleted` (`deleted` ASC),
  INDEX `ind_nj_agegic__nj_doc_holding_facilities_idx1` (`arrest_id` ASC),
  CONSTRAINT `ind_nj_agegic__nj_doc_holding_facilities1`
    FOREIGN KEY (`arrest_id`)
    REFERENCES `crime_inmate`.`nj_doc_arrests` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION
...
CREATE TABLE IF NOT EXISTS `crime_inmate`.`nj_doc_parole_booking_dates` (
  `id` BIGINT(20) NOT NULL AUTO_INCREMENT,
  `inmate_id` BIGINT(20) NULL DEFAULT NULL,
  ...
  `md5_hash` VARCHAR(255) NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  INDEX `ind_nj_agegic__nj_doc_parole_booking_dates_idx2` (`inmate_id` ASC),
  CONSTRAINT `ind_nj_agegic__nj_doc_parole_booking_dates2`
    FOREIGN KEY (`inmate_id`)
    REFERENCES `crime_inmate`.`nj_doc_inmates` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION
