 CREATE TABLE IF NOT EXISTS `ga_gwinnett_immate_ids` (
  ...
  `md5_hash`        VARCHAR (255)GENERATED ALWAYS AS(md5(concat_ws('',immate_id,type))) STORED,
  PRIMARY KEY (`id`),
  ...
  CONSTRAINT `fk_il_tazewell__arrestee_ids_il_tazewell__arrestees1`
    ...
    REFERENCES `crime_inmate`.`ga_gwinnett_immates` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
AUTO_INCREMENT = 2375
