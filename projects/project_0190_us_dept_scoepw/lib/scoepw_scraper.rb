...
class Scraper < Hamster::Scraper
  ...
  def blank_url_choose(type)
    case type
    when :news
      "https://www.epw.senate.gov/public/index.cfm/news?page="
    when :pr
      "https://www.epw.senate.gov/public/index.cfm/press-releases-republican?page="
    end
  end
  ...
  def gathering(update = 0, type=nil)
    ...
    blank_url = blank_url_choose(type) #todo:press
