CREATE TABLE IF NOT EXISTS `crime_inmate`.`westchester_new_york_bonds` (
  ...
  CONSTRAINT `fk_il_tazewell__bonds_il_tazewell__bonds11`
    FOREIGN KEY (`arrest_id`)
    REFERENCES `crime_inmate`.`westchester_new_york_arrests` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_il_tazewell__bonds_il_tazewell__arrests11`
    FOREIGN KEY (`charge_id`)
    REFERENCES `crime_inmate`.`westchester_new_york_charges` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8mb4
COLLATE = utf8mb4_unicode_520_ci
COMMENT = 'Created by Zaid Akram, Task #789';
