CREATE TABLE IF NOT EXISTS `crime_inmate`.`westchester_new_york_court_hearings` (
  ...
  `court_type` VARCHAR(255) NULL DEFAULT NULL,
  ...
  CONSTRAINT `fk_il_tazewell__court_hearings_il_tazewell__charges16`
