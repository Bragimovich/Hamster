use lawyer_status;
create table tennessee_memphis
(
    ...
    law_firm_state          varchar(30)                                 null,

    phone                   varchar(255)                               null,

    date_admitted           datetime                                 null,
    sections                varchar(2047)                               null,



    data_source_url         varchar(255) default 'https://www.memphisbar.org/?pg=PublicMembersDirectory&dirAction=search'                null,
