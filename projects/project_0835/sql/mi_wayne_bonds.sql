CREATE TABLE IF NOT EXISTS `crime_inmate`.`mi_wayne_bonds` (
  ...
  `total_bond_amount` VARCHAR(255) NULL DEFAULT NULL,
  ...
  CONSTRAINT `fk_il_tazewell__bonds_il_tazewell__bonds1_st`
