CREATE TABLE us_court_cases.vt_sc_case_additional_info
(
    `id`                    BIGINT(20) AUTO_INCREMENT PRIMARY KEY,
    `run_id`                BIGINT(20),
    `court_id`              INT               DEFAULT          NULL,
    `case_id`               VARCHAR(255)                NOT NULL,
    `lower_court_name`      VARCHAR(511)      DEFAULT          NULL,
    `lower_case_id`      	VARCHAR(255)      DEFAULT          NULL,
    `lower_judge_name`      VARCHAR(255)      DEFAULT          NULL,
    `lower_judgement_date` 	DATE              DEFAULT          NULL,
    `lower_link`     		VARCHAR(511)      DEFAULT          NULL,
    `disposition`           VARCHAR(511)      DEFAULT          NULL,
  ...
  COMMENT = 'Created by Zaid Akram, Task #565';
