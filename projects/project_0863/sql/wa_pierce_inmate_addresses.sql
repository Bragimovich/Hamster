CREATE TABLE `wa_pierce_inmate_addresses`
(
  ...
  INDEX         `fk_il_tazewell__arrestee_addresses_il_tazewell__arrestees1_idx` (`immate_id`) ,
  CONSTRAINT    `fk_il_tazewell__arrestee_addresses_il_tazewell__arrestees1`
