CREATE TABLE IF NOT EXISTS `crime_inmate`.`ut_utah_arrests` (
  ...
  CONSTRAINT `fk_il_tazewell__arrests_il_tazewell__arrestees814`
...
COMMENT = 'Created by Muhammad, Task #814';
