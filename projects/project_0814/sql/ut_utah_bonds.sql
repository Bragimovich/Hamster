CREATE TABLE IF NOT EXISTS `crime_inmate`.`ut_utah_bonds` (
  ...
  CONSTRAINT `fk_il_tazewell__bonds_il_tazewell__bonds814`
    FOREIGN KEY (`arrest_id`)
    REFERENCES `crime_inmate`.`ut_utah_arrests` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_il_tazewell__bonds_il_tazewell__arrests814`
    FOREIGN KEY (`charge_id`)
    REFERENCES `crime_inmate`.`ut_utah_charges` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8mb4
COLLATE = utf8mb4_unicode_520_ci
COMMENT = 'Created by Muhammad Musa, Task #0814';
