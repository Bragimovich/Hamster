CREATE TABLE IF NOT EXISTS `crime_inmate`.`il_dupage_inmate_ids` (
  ...
  `md5_hash` VARCHAR (255)GENERATED ALWAYS AS (md5(concat_ws('',number,type,CAST(date_from AS CHAR),CAST(date_to as CHAR),inmate_id))) STORED,
  PRIMARY KEY (`id`),
  ...
  CONSTRAINT `fk_il_tazewell__arrestee_ids_il_tazewell__arrestees809`
