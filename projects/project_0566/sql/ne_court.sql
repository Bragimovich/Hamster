CREATE TABLE `ne_court__mcle_wcc_ne_gov` 
(
  ...
  `md5_hash` varchar(100)  GENERATED ALWAYS AS (md5(concat_ws('',`bar_number`,`name`,`date_admitted`,`registration_status`,`type`,`phone`,`law_firm_name`,`law_firm_address`,`law_firm_zip`,`law_firm_city`,`law_firm_state`,`insurance`,`disciplinary_actions`))) STORED,
  PRIMARY KEY (`id`),
