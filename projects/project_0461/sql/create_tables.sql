...
CREATE TABLE `epdata_world_daily_case_counts`
(
  `id`                  BIGINT(20)   AUTO_INCREMENT PRIMARY KEY,
  # begin
  ...
  `csv_source_link`     VARCHAR(255) NOT NULL,
  # end
  `data_source_url`     TEXT         NOT NULL,
  `created_by`          VARCHAR(255)          DEFAULT 'Oleksii Kuts',
  `created_at`          DATETIME              DEFAULT CURRENT_TIMESTAMP,
  ...
  COLLATE = utf8mb4_unicode_520_ci
  comment = 'Created by Oleksii Kuts, task #461, monkeypox world cases data from epdata.es';
