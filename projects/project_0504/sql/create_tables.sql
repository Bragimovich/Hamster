CREATE TABLE `il_tazewell__arrestees`
(
  ...
  INDEX             `deleted` (`deleted`)
    ...
    COMMENT = 'Created by Victor Linnik, Task #504';
    
    
CREATE TABLE `il_tazewell_arrestee_ids`
(
  `id`              BIGINT(20) AUTO_INCREMENT PRIMARY KEY,
  `arrestee_id`     BIGINT,
  `number`          VARCHAR(255),
  ...
  INDEX             `deleted` (`deleted`)
    ...
    CREATE TABLE `il_tazewell__arrestee_addresses`
(
  `id`              BIGINT(20) AUTO_INCREMENT PRIMARY KEY,
...
CREATE TABLE `il_tazewell__arrestee_aliases`
(
  `id`              BIGINT(20) AUTO_INCREMENT PRIMARY KEY,
  `arrestee_id`     BIGINT,
  `full_name`       VARCHAR(255),
...
CREATE TABLE `il_tazewell__arrests`
(
  `id`                      BIGINT(20) AUTO_INCREMENT PRIMARY KEY,
  ...
  INDEX                     `deleted` (`deleted`)
    ...
    CREATE TABLE `il_tazewell__charges`
(
  `id`                  BIGINT(20) AUTO_INCREMENT PRIMARY KEY,
  `arrest_id`           BIGINT(20),
  `number`              VARCHAR(255),
  ...
  INDEX                 `deleted` (`deleted`)
    ...
    CREATE TABLE `il_tazewell__court_hearings`
(
  `id`                  BIGINT(20) AUTO_INCREMENT PRIMARY KEY,
  `charge_id`           BIGINT(20),
  ...
  INDEX                 `deleted` (`deleted`)
    ...
    CREATE TABLE `il_tazewell__bonds`
(
  `id`                      BIGINT(20) AUTO_INCREMENT PRIMARY KEY,
  `arrest_id`               BIGINT(20),
  `charge_id`               BIGINT(20),
  ...
  INDEX                     `deleted` (`deleted`)
    ...
    CREATE TABLE `il_tazewell__holding_facilities`
(
  `id`                      BIGINT(20) AUTO_INCREMENT PRIMARY KEY,
  `arrest_id`               BIGINT(20),
...
CREATE TABLE `il_tazewell__mugshots`
(
    `id`                      BIGINT(20) AUTO_INCREMENT PRIMARY KEY,
    `arrestee_id`             BIGINT(20),
