CREATE TABLE IF NOT EXISTS `crime_inmate`.`fl_polk_charges` (
  ...
  INDEX `fk_fl_polk_arrests_idx` (`arrest_id` ASC) ,
  CONSTRAINT `fk_fl_polk_arrests__arrests1`
    FOREIGN KEY (`arrest_id`)
    REFERENCES `crime_inmate`.`fk_polk_arrests` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
