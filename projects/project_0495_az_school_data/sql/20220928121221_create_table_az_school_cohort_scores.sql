CREATE TABLE `az_school_cohort_scores` (
`id` bigint(20) NOT NULL AUTO_INCREMENT,
`year` varchar(255) DEFAULT NULL,
`graduation_rate_type` varchar(255) DEFAULT NULL,
...
`number_graduated` varchar(255) DEFAULT NULL,
`number_in_cohort` varchar(255) DEFAULT NULL,
`percent_graduated_in_4_years` varchar(255) DEFAULT NULL,
