CREATE TABLE IF NOT EXISTS `crime_inmate`.`california_fresno_bonds` (
  ...
  CONSTRAINT `fk_il_tazewell__bonds_il_tazewell__bonds10`
    FOREIGN KEY (`arrest_id`)
    REFERENCES `crime_inmate`.`california_fresno_arrests` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_il_tazewell__bonds_il_tazewell__arrests10`
