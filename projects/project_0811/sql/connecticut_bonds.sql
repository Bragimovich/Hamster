CREATE TABLE IF NOT EXISTS `crime_inmate`.`connecticut_bonds`
(
  ...
  CONSTRAINT `fk_il_tazewell__bonds_il_tazewell__bonds1_bonds`
    FOREIGN KEY (`arrest_id`)
    REFERENCES `crime_inmate`.`connecticut_arrests` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_il_tazewell__bonds_il_tazewell__arrests1_bonds`
    FOREIGN KEY (`charge_id`)
    REFERENCES `crime_inmate`.`connecticut_charges` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION
)
ENGINE = InnoDB
