...
class Scraper < Hamster::Scraper
  ...
  def gathering(update = 0)
    ...
    loop do
      p page
      url = "https://www.blm.gov/press-release?combine=&field_release_date_value=1&page=" + page.to_s
      ...
      break if list_news.length<25
      break if news_to_db.length<25 and update==1
      page +=1
