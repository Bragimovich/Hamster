CREATE TABLE IF NOT EXISTS `crime_inmate`.`minnesota_inmates` (
  ...
  `md5_hash` VARCHAR (255)GENERATED ALWAYS AS (md5(concat_ws('',full_name,CAST(birthdate as CHAR)))) STORED,
  PRIMARY KEY (`id`),
