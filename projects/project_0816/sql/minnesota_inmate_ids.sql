CREATE TABLE IF NOT EXISTS `crime_inmate`.`minnesota_inmate_ids` (
  ...
  `md5_hash` VARCHAR (255)GENERATED ALWAYS AS (md5(concat_ws('',number,type,inmate_id))) STORED,
  PRIMARY KEY (`id`),
  ...
  CONSTRAINT `fk_il_tazewell__arrestee_ids_il_tazewell__arrestees816`
