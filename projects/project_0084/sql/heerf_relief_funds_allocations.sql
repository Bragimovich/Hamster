CREATE TABLE heerf_relief_funds_allocations
(
    ...
    CONSTRAINT `institution_fk` FOREIGN KEY (`institution_id`) REFERENCES `heerf_relief_funds_institutions` (`id`) on delete cascade
