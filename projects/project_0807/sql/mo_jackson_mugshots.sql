CREATE TABLE IF NOT EXISTS `crime_inmate`.`mo_jackson_mugshots` (
  ...
  INDEX `fk_il_tazewell__mugshots_il_tazewell__arrestees1_idx807` (`immate_id` ASC) ,
  CONSTRAINT `fk_il_tazewell__mugshots_il_tazewell__arrestees807`
