...
create table il_parole_population_date_scrape
(
    ...
    pl_prod_county_id                 varchar(2000)                       null,
...
create index holding_offense_index
    on il_parole_population_date_scrape (holding_offense);

create index period_idoc_index
    on il_parole_population_date_scrape (period, idoc);
