CREATE TABLE IF NOT EXISTS `crime_inmate`.`ca_riverside_holding_facilities` (
  ...
  INDEX `fk_rs_tazewell__holding_facilities_il_tazewell__arrests1_idx` (`arrest_id` ASC) ,
  CONSTRAINT `fk_riverside_tazewell__holding_facilities_il_tazewell__arrests1`
