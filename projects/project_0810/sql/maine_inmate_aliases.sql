CREATE TABLE IF NOT EXISTS `crime_inmate`.`maine_inmate_aliases` (
  ...
  INDEX `fk_il_tazewell__arrestee_aliases_il_tazewell__arrestees1_idx` (`inmate_id` ASC),
  CONSTRAINT `fk_il_tazewell__arrestee_aliases_il_tazewell__arrestees810`
