CREATE TABLE us_schools_raw.in_schools_sat
(
    ...
    below_benchmark	        VARCHAR(255),
    approaching_benchmark   VARCHAR(255),
    at_benchmark	        VARCHAR(255),
    total_tested	        VARCHAR(255),
    benchmark_percent	    VARCHAR(255),
