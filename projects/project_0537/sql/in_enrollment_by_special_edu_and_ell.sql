CREATE TABLE us_schools_raw.in_enrollment_by_special_edu_and_ell
(
    id	                BIGINT(20) AUTO_INCREMENT PRIMARY KEY,
    general_id	        BIGINT(20),
    school_year	        VARCHAR(50),
    ell_count	        VARCHAR(255),
    ell_percent	        VARCHAR(255),
    special_edu_count	VARCHAR(255),
    special_edu_percent	VARCHAR(255),
