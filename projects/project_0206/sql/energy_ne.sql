...
(
    ...
    creator                     VARCHAR(255) DEFAULT 'U.S. Dept. of Energy, Office of Nuclear Energy',
    country                     VARCHAR(255) DEFAULT 'US',
    date                        DATETIME DEFAULT NULL,
    dirty_news                  TINYINT DEFAULT 0,
    with_table                  TINYINT DEFAULT 0,
    data_source_url             VARCHAR(255) DEFAULT 'https://www.energy.gov/ne/listings/ne-press-releases',
