CREATE TABLE `GA_RAW_COMMITTEES`
(
  ...
  `committee_affiliation`    VARCHAR(255),
  `committee_type`           VARCHAR(255),
  `committee_recall_office`  VARCHAR(255),
  `committee_recall_officer` VARCHAR(255),
  # END
  ...
  COLLATE = utf8mb4_unicode_520_ci
    COMMENT = 'COMMITTEES from media.ethics.ga.gov, Created by Oleksii Kuts, Task #769';
