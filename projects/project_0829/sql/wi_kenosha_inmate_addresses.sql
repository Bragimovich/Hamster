CREATE TABLE IF NOT EXISTS `crime_inmate`.`wi_kenosha_inmate_addresses` (
  ...
  INDEX `fk_il_tazewell__arrestee_addresses_il_tazewell__arrestees1_idx` (`inmate_id` ASC) ,
  CONSTRAINT `fk_il_tazewell__arrestee_addresses_il_tazewell__arresteeswi`
