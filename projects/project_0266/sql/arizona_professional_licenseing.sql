CREATE TABLE `arizona_professional_licenseing`
(
  ...
  `md5_hash`                                      VARCHAR (255)GENERATED ALWAYS AS (md5(concat_ws('',license_type,license_expiration_date,status,full_name,first_name,last_name,street,city,state,phone,zip))) STORED,
