CREATE TABLE IF NOT EXISTS `crime_inmate`.`nj_essex_mugshots` (
  ...
  INDEX `fk_il_tazewell__mugshots_il_tazewell__arrestees1_idx` (`immate_id` ASC),
  CONSTRAINT `fk_il_tazewell__mugshots_il_tazewell__arrestees825`
