...
module Hamster
  module CaptchaAdapter
    ...
    RESPONSE_ERRORS = {
      'ERROR_WRONG_USER_KEY'           => CaptchaAdapter::WrongUserKey,
      'ERROR_KEY_DOES_NOT_EXIST'       => CaptchaAdapter::InvalidUserKey,
      'ERROR_ZERO_BALANCE'             => CaptchaAdapter::ZeroBalance,
      'ERROR_NO_SLOT_AVAILABLE'        => CaptchaAdapter::NoSlotAvailable,
      'ERROR_ZERO_CAPTCHA_FILESIZE'    => CaptchaAdapter::SmallCaptchaFilesize,
      'ERROR_TOO_BIG_CAPTCHA_FILESIZE' => CaptchaAdapter::BigCaptchaFilesize,
      'ERROR_WRONG_FILE_EXTENSION'     => CaptchaAdapter::WrongFileExtension,
      'ERROR_IMAGE_TYPE_NOT_SUPPORTED' => CaptchaAdapter::ImageNotSupported,
      'ERROR_IP_NOT_ALLOWED'           => CaptchaAdapter::IpNotAllowed,
      'IP_BANNED'                      => CaptchaAdapter::IpBanned,
      'ERROR_WRONG_ID_FORMAT'          => CaptchaAdapter::WrongIdFormat,
      'ERROR_CAPTCHA_UNSOLVABLE'       => CaptchaAdapter::CaptchaUnsolvable,
      'ERROR_EMPTY_ACTION'             => CaptchaAdapter::EmptyAction,
      'ERROR_GOOGLEKEY'                => CaptchaAdapter::GoogleKey,
      'ERROR_CAPTCHAIMAGE_BLOCKED'     => CaptchaAdapter::CaptchaImageBlocked,
      'ERROR_WRONG_CAPTCHA_ID'         => CaptchaAdapter::WrongCaptchaId,
      'ERROR_BAD_DUPLICATES'           => CaptchaAdapter::BadDuplicates,
      'REPORT_NOT_RECORDED'            => CaptchaAdapter::ReportNotRecorded,
    }
  end
end
